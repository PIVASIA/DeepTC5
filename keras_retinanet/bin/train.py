...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            ...
            evaluation = Evaluate(validation_generator, tensorboard=tensorboard_callback, csv_logger=os.path.join(self.logger_dir, 'eval.csv'), weighted_average=args.weighted_average)
