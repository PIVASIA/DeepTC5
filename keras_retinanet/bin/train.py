...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            ...
            evaluation = Evaluate(validation_generator, tensorboard=tensorboard_callback, csv_logger=os.path.join(args.logger_dir, 'eval.csv'), weighted_average=args.weighted_average)
...
def parse_args(args):
    ...
    parser.add_argument('--input_depth_a',    help='Input depth.', default=3, type=int)
    parser.add_argument('--input_depth_b',    help='Input depth.', default=3, type=int)
    parser.add_argument('--batch-size',       help='Size of the batches.', default=1, type=int)
    parser.add_argument('--gpu',              help='Id of the GPU to use (as reported by nvidia-smi).')
    parser.add_argument('--multi-gpu',        help='Number of GPUs to use for parallel processing.', type=int, default=0)
    parser.add_argument('--multi-gpu-force',  help='Extra flag needed to enable (experimental) multi-gpu support.', action='store_true')
    parser.add_argument('--epochs',           help='Number of epochs to train.', type=int, default=50)
    parser.add_argument('--save-freq',        help='Number of epochs to save the model.', default=10, type=int)
